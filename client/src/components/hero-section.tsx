...
export function HeroSection() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-20 relative bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 overflow-hidden">
      {/* Full-width Martinez Pattern Background - Dimmed */}
      <div className="absolute inset-0 w-full h-full opacity-40">
        <MartinezPattern opacity={0.01} />
      </div>
      {/* Full-width background overlay - Subtle */}
      <div className="absolute inset-0 bg-gradient-to-r from-primary/3 via-transparent to-primary/3"></div>
      <div className="max-w-5xl mx-auto text-center animate-fadeInUp relative z-20 px-4 sm:px-6 lg:px-8">
        {/* Skills Showcase - Dimmed to highlight search bar */}
        <div className="mb-8 relative opacity-60">
          <div className="flex flex-wrap justify-center items-center gap-4 mb-6">
            {/* Design & Simulation */}
            <div className="cursor-pointer">
              <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-primary/8 to-primary/4 dark:from-primary/15 dark:to-primary/8 flex items-center justify-center shadow-md">
                <svg className="w-8 h-8 text-primary/70" fill="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-1 text-center font-medium">Simulation</p>
            </div>
            ...
            <div className="cursor-pointer">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-1 text-center font-medium">Programming</p>
            </div>
            ...
            <div className="cursor-pointer">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-1 text-center font-medium">Prototyping</p>
            </div>
            ...
            <div className="cursor-pointer">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-1 text-center font-medium">Tech Tools</p>
            </div>
            ...
            <div className="cursor-pointer">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-1 text-center font-medium">Soft Skills</p>
            </div>
          </div>
        </div>
        
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-8 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
          Julián Martínez
        </h1>
        
        {/* AI Search Bar - Hero Feature */}
        <div className="mb-8 relative">
          <div className="absolute -inset-4 bg-gradient-to-r from-primary/10 via-transparent to-primary/10 rounded-3xl blur-xl opacity-50"></div>
          <AISearchBar />
        </div>
        
        <div className="text-xl sm:text-2xl text-slate-600 dark:text-slate-300 mb-2 font-semibold opacity-80">
          Mechanical Engineer | Robotics | AI | Builder
        </div>
        
        <p className="text-lg text-slate-500 dark:text-slate-400 mb-8 max-w-2xl mx-auto opacity-75">
