          ...
          <div className="flex flex-wrap justify-center items-center gap-6 mb-8">
            ...
            <div className="group cursor-pointer relative">
              ...
              <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-4 py-3 bg-slate-900 dark:bg-slate-800 text-white text-sm rounded-lg shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-20 w-64">
                ...
                <div className="text-xs text-slate-400">Created water-oil separator and heat exchanger designs with precise engineering specifications.</div>
            ...
            <div className="group cursor-pointer relative">
              ...
              <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-4 py-3 bg-slate-900 dark:bg-slate-800 text-white text-sm rounded-lg shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-20 w-64">
                ...
                <div className="text-xs text-slate-300 mb-2">Industrial automation and control systems</div>
                <div className="text-xs text-slate-400">Built automated assembly line project with sensor integration and process control.</div>
                <div className="w-full bg-slate-700 rounded-full h-2 mt-2">
            ...
            <div className="group cursor-pointer relative">
              ...
              <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-4 py-3 bg-slate-900 dark:bg-slate-800 text-white text-sm rounded-lg shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-20 w-64">
                ...
                <div className="text-xs text-slate-300 mb-2">Finite Element Analysis and CFD simulation</div>
                <div className="text-xs text-slate-400">Achieved 25% efficiency improvement in heat exchanger design through thermal analysis optimization.</div>
                <div className="w-full bg-slate-700 rounded-full h-2 mt-2">
            ...
            <div className="group cursor-pointer relative">
              ...
              <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-4 py-3 bg-slate-900 dark:bg-slate-800 text-white text-sm rounded-lg shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-20 w-64">
                ...
                <div className="text-xs text-slate-300 mb-2">Full-stack web and mobile development</div>
                <div className="text-xs text-slate-400">Built Spots App for social venue discovery with real-time features and user authentication.</div>
                <div className="w-full bg-slate-700 rounded-full h-2 mt-2">
            ...
            <div className="group cursor-pointer relative">
              ...
              <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-4 py-3 bg-slate-900 dark:bg-slate-800 text-white text-sm rounded-lg shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-20 w-64">
                ...
                <div className="text-xs text-slate-300 mb-2">Creative engineering and analytical thinking</div>
